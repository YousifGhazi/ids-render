...
export default function TemplateFormPage() {
  ...
  useEffect(() => {
    const authData = {
      state: {
        token:
          "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..ZXc29KftKzkLPodPT5LtHVrh7LAqlULA-jpsjs69j7E",
      },
    };
    ...
    return (
      <Container size="md" py="xl">
        <Stack gap="xl" align="center">
          <Card withBorder radius="md" p="xl" w="100%" maw={600}>
            <Stack align="center" gap="lg">
              ...
              <Title order={2} size="h3" ta="center" c="green">
                {tIds("thankYou")}
              </Title>
              
              <Stack gap="sm" align="center">
                {/* <Text size="lg" fw={500} ta="center">
                  {tIds("submissionSuccess")}
                </Text> */}
                <Text size="md" c="dimmed" ta="center">
                  {tIds("submissionSuccessMessage")}
                </Text>
              </Stack>
              ...
              <Stack gap="xs" align="center">
                <Text size="sm" c="dimmed" ta="center" style={{ fontStyle: "italic" }}>
                  Thank you for your submission • شكراً لك على تقديم طلبك
                </Text>
              </Stack>
            </Stack>
          </Card>
